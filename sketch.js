...
var fruit_con_2;
var fruit_con_3;
var rope3, star1, star2, starImg, blower, starCounter, zStar, oStar, tStar;
...
function setup() 
{
  ...
  starCounter.addAnimation('empty',zStar)
  starCounter.addAnimation('one',oStar)
  starCounter.addAnimation('full',tStar)
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if (collide(fruit,star2,20)==true) {
     star2.visible=false
     starCounter.changeAnimation('full')
   }
